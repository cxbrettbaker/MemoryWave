...
public class RightCatController : MonoBehaviour
{
    private Image image;
    ...
    void Start()
    {
        ...
        leftHandKey = FindObjectOfType<GameManager>().keyRight; // these need to be flipped since the sprite is mirrored
        rightHandKey = FindObjectOfType<GameManager>().keyUp;
    }
